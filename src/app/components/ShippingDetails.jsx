  ...
  return (
    <div className="bg-[#15191D] px-4 grid lg:flex grid-cols-2 py-4 gap-5">
      <div className="flex items-center gap-2.5">
        <Image src={"/img/scooter.png"} width={28} height={28} />
      ...
      <div className="flex items-center gap-2.5">
        <Image src={"/img/debit.png"} width={28} height={28} />
        <div className="text-white">
          <p>Online Payment</p>
      ...
      <div className="flex items-center gap-2.5">
        <Image src={"/img/easy.png"} width={28} height={28} />
        <div className="text-white">
          <p>Easy Return</p>
      ...
      <div className="flex items-center gap-2.5">
        <Image src={"/img/customer.png"} width={28} height={28} />
        <div className="text-white">
          <p>24/7 Support</p>
